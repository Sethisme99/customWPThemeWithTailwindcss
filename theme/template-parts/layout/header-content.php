...
<nav id="site-navigation" class="bg-[#2C799A]">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 px-6">
    ...
    <div class="inline-flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <a href="/wp-login.php" class=" w-full flex justify-center items-center gap-2 rounded-sm bg-purple-500 hover:bg-purple-600 focus:bg-purple-400 shadow-xs px-2 py-2 focus:outline-none cursor-pointer mr-0">
        <p class="font-bold leading-5 text-sm text-white">Login</p>
    ...
    <div id="primary-menu-wrap" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
      <?php
        wp_nav_menu([
          ...
          'container'      => false,
          'menu_class'     => 'font-medium text-[#FFFFFF] flex flex-col p-0 md:p-0 mt-4 gap-2 rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-2 md:mt-0 md:border-0 md:gap-0 lg:gap-0',
          'fallback_cb'    => false,
